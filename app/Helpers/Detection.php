...
class Mobile_Detect {
    ...
    public static function getOSVer($user_agent) {
    ...
    public static function getOS($user_agent) {
        $os_platform = "Unknown OS Platform";
        $os_array = array(
            '/windows nt 10/i' => /* 'Windows 10' */ Configuration::OS_WINDOWS,
            '/windows nt 6.3/i' => /* 'Windows 8.1' */ Configuration::OS_WINDOWS,
            '/windows nt 6.2/i' => /* 'Windows 8' */ Configuration::OS_WINDOWS,
            '/windows nt 6.1/i' => /* 'Windows 7' */ Configuration::OS_WINDOWS,
            '/windows nt 6.0/i' => /* 'Windows Vista' */ Configuration::OS_WINDOWS,
            '/windows nt 5.2/i' => /* 'Windows Server 2003/XP x64' */ Configuration::OS_WINDOWS,
            '/windows nt 5.1/i' => /* 'Windows XP' */ Configuration::OS_WINDOWS,
            '/windows xp/i' => /* 'Windows XP' */ Configuration::OS_WINDOWS,
            '/windows nt 5.0/i' => /* 'Windows 2000' */ Configuration::OS_WINDOWS,
            '/windows me/i' => /* 'Windows ME' */ Configuration::OS_WINDOWS,
            '/win98/i' => /* 'Windows 98' */ Configuration::OS_WINDOWS,
            '/win95/i' => /* 'Windows 95' */ Configuration::OS_WINDOWS,
            '/win16/i' => /* 'Windows 3.11' */ Configuration::OS_WINDOWS,
            '/macintosh|mac os x/i' => /* 'Mac OS X' */ Configuration::OS_MAC,
            '/mac_powerpc/i' => /* 'Mac OS 9' */ Configuration::OS_MAC,
            '/linux/i' => /* 'Linux' */ Configuration::OS_LINUX,
            '/ubuntu/i' => /* 'Ubuntu' */ Configuration::OS_LINUX,
            '/iphone/i' => /* 'iPhone' */ Configuration::OS_IOS,
            '/ipod/i' => /* 'iPod' */ Configuration::OS_IOS,
            '/ipad/i' => /* 'iPad' */ Configuration::OS_IOS,
            '/android/i' => /* 'Android' */ Configuration::OS_ANDROID,
            '/blackberry/i' => /* 'BlackBerry' */ Configuration::OS_BLACKBERRY,
    ...
    public static function getBrowserDetails() {
