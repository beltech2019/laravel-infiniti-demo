...
<div class="row">
    <div class="col-md-12">
        <form action="{{ route('admin.promotionsupdate') }}" method="POST">
            @csrf
            <div class="card shadow-sm">
                <div class="card-header">
                    <h5 class="mb-0">Promotions Data</h5>
                </div>
            ...
            <div class="text-end mt-3">
                <button type="submit" class="btn btn-primary">Save Promotions Data</button>
            </div>
        </form>
    </div>
</div>
