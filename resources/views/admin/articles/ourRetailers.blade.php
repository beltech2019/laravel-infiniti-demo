...
<div class="row">
    <div class="col-md-12">
        <form action="{{ route('admin.ourRetailersupdate') }}" method="POST">
            @csrf
            <div class="card shadow-sm">
                <div class="card-header">
                    <h5 class="mb-0">Our Retailers Data</h5>
                </div>
            ...
            <div class="text-end mt-3">
                <button type="submit" class="btn btn-primary">Save Our Retailres Data</button>
            </div>
        </form>
    </div>
</div>
