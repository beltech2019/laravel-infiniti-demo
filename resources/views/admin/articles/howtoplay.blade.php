...
<div class="row">
    <div class="col-md-12">
        <form action="{{ route('admin.cookiePolicyupdate') }}" method="POST">
            @csrf
            <div class="card shadow-sm">
                <div class="card-header">
                    <h5 class="mb-0">How To Play Data</h5>
                </div>
            ...
            <div class="text-end mt-3">
                <button type="submit" class="btn btn-primary">Save How To Play Data</button>
            </div>
        </form>
    </div>
</div>
